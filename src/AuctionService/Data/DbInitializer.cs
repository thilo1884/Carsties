...
{
    // we use static because it allows us to use this method inside another class without initialize a new class DBinitializer
    public static void InitDb(WebApplication app)
    {
        // to create the scope for the service inside here
